...
use AsayDev\LaraTickets\Console\SetupLaraTicketsPackage;
...
use AsayDev\LaraTickets\Livewire\Components\Tickets\LaraTicketsReplies;
...
use AsayDev\LaraTickets\Livewire\Components\Statistics\LaraTicketsStatisticsAgents;
use Livewire\Livewire;
use AsayDev\LaraTickets\Livewire\Components\Statistics\LaraTicketsStatisticsCategories;
use AsayDev\LaraTickets\Livewire\Components\Statistics\LaraTicketsStatisticsUsers;
...
class AsayDevLaraTicketsServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->mergeConfigFrom(
            __DIR__ . '/../config/laratickets.php',
            'laratickets'
        );
    }
    ...
    public function boot()
    {
        ...
        Livewire::component('lara-tickets-replies', LaraTicketsReplies::class);
        ...
        Livewire::component('lara-tickets-statistics-categories', LaraTicketsStatisticsCategories::class);
        Livewire::component('lara-tickets-statistics-agents', LaraTicketsStatisticsAgents::class);
        Livewire::component('lara-tickets-statistics-users', LaraTicketsStatisticsUsers::class);
        ...
        //$loader->addJsonPath(__DIR__ . '/../resources/lang');
        ...
        $this->publishes([
            ...
            __DIR__ . '/../assets/ckeditor' => public_path('laratickets/ckeditor'),
        ], 'laratickets_assets');
