            ...
            <div class="col-lg-4 mt-3">
                <nav>
                    <ul class="nav nav-pills nav-justified">
                        <li class="nav-item">
                            <a class="nav-link  {{$active_tab == "cat" ? "active" : ""}}"  wire:click="setActiveTab('cat)" data-toggle="pill" href="#information-panel-categories">
                                <i class="fas fa-folder"></i>
                                <small>{{ trans('laratickets::admin.index-categories') }}</small>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{$active_tab == "agents" ? "active"  : ""}}" wire:click="setActiveTab('agents)" data-toggle="pill" href="#information-panel-agents">
                                <i class="fas fa-user-secret"></i>
                                <small>{{ trans('laratickets::admin.index-agents') }}</small>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{$active_tab == "users" ? "active" : ""}}" wire:click="setActiveTab('users)" data-toggle="pill" href="#information-panel-users">
