...
use AsayDev\LaraTickets\Models\Setting as Table;
...
class Setting extends Model
{
    ...
    public static function grab($slug)
    {
        ...
        $setting = Cache::remember('laratickets::settings.'.$slug, $time, function () use ($slug, $time) {
            $settings = Cache::remember('laratickets::settings', $time, function () {
                return Table::all();
            });
