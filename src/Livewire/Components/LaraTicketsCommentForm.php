...
class LaraTicketsCommentForm extends Component
{
    ...
    public function renderLaraTicketsContentEditor()
    {
    ...
    {
        $paginate_items = 10;
        return view('asaydev-lara-tickets::forms.comment', ['comments' => $this->ticket->comments()->orderBy('id', 'asc')->get()]);
        //->paginate($paginate_items->value)]);
    }
