<div class="card-body" wire:init="initData">
    <form wire:submit.prevent="saveData">
        ...
        $this->dashboardData['form']['action']=='add'&&
        $this->dashboardData['model']==='general')
        ...
        <div class="form-group row">
            ...
            <div class="col-lg-10" wire:ignore>
                <textarea rows="5" class="form-control" id="editorContent" wire:model="content"></textarea>
                <small class="form-text text-muted">{!! trans('laratickets::lang.create-ticket-brief-issue') !!}</small>
        ...
        <div class="form-row mt-5">
            <label class="col-lg-2 col-form-label" for="priority">{!! trans('laratickets::lang.priority') .
                trans('laratickets::lang.colon') !!}</label>
            <div class="col-lg-10">
        ...
        <div class="form-row mt-5">
            <label class="col-lg-2 col-form-label" for="category">{!! trans('laratickets::lang.category') .
                trans('laratickets::lang.colon') !!}</label>
            <div class="col-lg-10">
        ...
        <div class="form-row mt-5">
            <label class="col-lg-2 col-form-label" for="category">{!! trans('laratickets::lang.agent') .
                trans('laratickets::lang.colon') !!}</label>
            <div class="col-lg-10">
