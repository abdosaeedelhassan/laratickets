<div>
    <div wire:init="renderContentEditor">
        ...
        @if(!$ticket->completed_at)
            ...
            <div class="row mt-3">
                <label class="col-md-2">{{trans('laratickets::lang.attachments')}}</label>
                <div class="col-md-10">
                    <input type="file" wire:model="attachments" name="attachments" id="attachments" multiple class="form-control">
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-md-12">
